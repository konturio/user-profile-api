...
public class ModelSavingIT {
    ...
    //     AppUserFeature appUserFeature = new AppUserFeature(app,
    //                                                        isemichastnov,
    //                                                        publicNonBetaFeature);
    ...
    //     //public feature
    //     Feature publicFeature = entityManager
    //         .createQuery("from Feature where name = ?1", Feature.class)
    //         .setParameter(1, Feature.Names.MAP_LAYERS_PANEL).getSingleResult();
    //     //non-public, non-beta feature
    //     Feature nonPublicNonBetaFeature = entityManager
    //         .createQuery("from Feature where name = ?1", Feature.class)
    //         .setParameter(1, Feature.Names.ANALYTICS_PANEL).getSingleResult();
    //     //non-public, beta feature
    //     Feature nonPublicBetaFeature = entityManager
    //         .createQuery("from Feature where name = ?1", Feature.class)
    //         .setParameter(1, Feature.Names.INTERACTIVE_MAP)
    //         .getSingleResult();
    //     //event feed chosen by user
    //     Feature eventFeed = entityManager
    //         .createQuery("from Feature where name = ?1", Feature.class)
    //         .setParameter(1, "test-gdacs").getSingleResult();
    ...
    //         .featuresEnabledByUser(List.of(publicFeature,
    //                                        nonPublicNonBetaFeature,
    //                                        nonPublicBetaFeature,
    //                                        eventFeed))
    //         .useMetricUnits(true)
    //         .subscription(subscription)
    //         .build();
