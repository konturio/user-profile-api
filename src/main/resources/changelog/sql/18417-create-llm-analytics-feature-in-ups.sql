...
values ('llm_analytics', 'UI_PANEL', true, true, false, false, 'AI analytics panel connected to open.ai and allowed to get personalized analytics based on user`s bio from their profile');
